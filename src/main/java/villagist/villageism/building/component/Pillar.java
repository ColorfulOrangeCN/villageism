...
public class Pillar extends PaintedComponent {
    protected int height;
    public Pillar(Painter painter, int height) {
        super(painter);
        this.height = height;
    }
    ...
    public PlacedBlock[] getStructure() {
        ...
        for (int i = 0; i < height; ++i) {
            goal[i] = new PlacedBlock(new Vec3i(0, i, 0), painter.getState(0, i, 0));
        }
        return goal;
    }
    ...
    public static void registerDebugCommand() {
        CommandRegistrationCallback.EVENT.register((dispatcher, dedicated) -> dispatcher.register(CommandManager.literal("villageismcreatepillar")
                ...
                .executes(context -> {
                    ...
                    ArrayList<PlacedBlock> blockList = new Construction().addComponent(new Pillar(new UniqueMaterial(block), height), position).serialisePlan();
